    ...
    <section className={cn('w-full', className)}>
      ...
      <div className="max-w-lg mx-auto mb-6">
        <div className="flex items-center gap-2">
          <div className="flex-1 rounded-full border border-white/[0.08] bg-white/[0.02] px-5 py-2.5 overflow-hidden">
            <p className="text-sm font-mono truncate text-foreground/70">{fullUrl}</p>
          </div>
          <button
            onClick={() => handleShare('copy')}
            className={cn(
              'flex items-center gap-2 px-5 py-2.5 rounded-full shrink-0',
      ...
      <div className="max-w-lg mx-auto mb-6">
        ...
        >
          <svg
            className={cn('w-4 h-4 transition-transform', showSocialOptions && 'rotate-180')}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
          ...
          <span>{showSocialOptions ? 'Hide social options' : 'Share to social platforms'}</span>
        </button>
        ...
        {showEmbed && (
          <div className="mt-4 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-4">
            ...
            <button
              ...
              className={cn(
                'mt-3 flex items-center gap-2 px-4 py-2 rounded-full text-sm',
                'transition-all duration-200',
                embedCopied
                  ? 'bg-emerald-500/10 border border-emerald-500/30 text-emerald-500'
                  : 'bg-white/[0.03] border border-white/[0.08] text-foreground/80 hover:bg-white/[0.06] hover:text-foreground'
